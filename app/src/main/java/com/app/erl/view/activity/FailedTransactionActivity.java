...
import com.app.erl.databinding.ActivityFailedTransactionBinding;
...
public class FailedTransactionActivity extends BaseActivity {
    private TextView mTextView;
    private ActivityFailedTransactionBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setStatusBarColor();
        binding = DataBindingUtil.setContentView(this, R.layout.activity_failed_transaction);
        mContext = this;
        ...
        if (status != null && !StringHelper.isEmpty(status.getTrace())) {
            ...
            manageOrderViewModel.storePaymentInfoRequest(AppConstant.ORDER_ID, 2, status.getTrace());
        }
